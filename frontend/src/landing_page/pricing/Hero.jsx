...
function Hero() {
  return (
    <div className='conatiner ' style={{paddingInline:'5rem'}}>
      <div className='row mt-5 p-5 border-bottom text-center'>
        <h1>Pricing</h1>
        <h3 className='text-muted mt-5 fs-5'>   Free equity investments and flat ₹20 traday and F&O trades</h3>
      </div>
      <div className='row p-5 mt-5 text-center'>
        <div className='col-4 p-4'>
          <img src="media/images/pricingEquity.svg" alt="pricing equity image" />
          <h1 className='fs-3'>Free Equity delivery</h1>
          <p className='text-muted'> All equity delivery investments (NSE, BSE), are absolutely free — ₹
            0 brokerage.</p>
        </div>
        <div className='col-4 p-4'>
          <img src="media/images/intradayTrades.svg" alt="pricing equity image" />
